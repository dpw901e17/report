...
In GCN Compute Units are the basic computational blocks of the GCN architecture, Figure \todo{ref fig} visualizes how each Compute Unit(CU) is structured in GCN.
