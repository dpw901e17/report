...
\paragraph{The \gls{ALU}} performs the actual computations on the fetched data. Any temporary variables or conditions (when handling branches) are stored/retrieved from the Execution Context.
...
\subsection{\arcshort{CPU} Style Core}
...
The result of slimming down the core can be seen in Figure \ref{twoSlimCores}.
