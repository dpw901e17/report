...
\fig{figures/\gls{GCN}_compute_unit}{Overview of the \gls{GCN} architecture}{\gls{GCN}CU}}{1} 

In \gls{GCN} Compute Units are the basic computational blocks of the \gls{GCN} architecture, Figure \ref{fig:\gls{GCN}CU}} visualizes how each \gls{CU} is structured in \gls{GCN}.
